...
// Смотрел семинар почти все понял, но когда перешёл по ссылке на гит,появилось очень много того, чего небыло в семинаре, попытался разобраться
// но времени чутка не хватило. Просто студент и готовлюсь к сессиям и защите проекта. Сделал как мог. Извините за то что очень поздно сдаю задания.
